<?php
    ...
    $result = mysqli_query($link, "SELECT * FROM    data_users WHERE login='$login' AND    password='$password'"); 
...
//     $result = mysqli_query($link, "SELECT * FROM data_users WHERE login='$login'"); //извлекаем из базы все данные о пользователе с введенным логином
//     $myrow = mysqli_fetch_array($result);
